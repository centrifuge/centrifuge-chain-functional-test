...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    anchor: {
       ...
       * later
       **/
      preCommits: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<PreCommitData>> & QueryableStorageEntry<ApiType>;
      /**
       * Pre-commit eviction buckets keep track of which pre-commit can be evicted at which point
       **/
      preCommitEvictionBuckets: AugmentedQuery<ApiType, (arg: ITuple<[BlockNumber, u64]> | [BlockNumber | AnyNumber | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Hash>> & QueryableStorageEntry<ApiType>;
      preCommitEvictionBucketIndex: AugmentedQuery<ApiType, (arg: BlockNumber | AnyNumber | Uint8Array) => Observable<u64>> & QueryableStorageEntry<ApiType>;
      /**
       * Index to find the eviction date given an anchor id
       **/
      anchorEvictDates: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<u32>> & QueryableStorageEntry<ApiType>;
      /**
       * Incrementing index for anchors for iteration purposes
       **/
      anchorIndexes: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Hash>> & QueryableStorageEntry<ApiType>;
      /**
       * Latest anchored index
       **/
      latestAnchorIndex: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      latestEvictedAnchorIndex: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      latestEvictedDate: AugmentedQuery<ApiType, () => Observable<u32>> & QueryableStorageEntry<ApiType>;
      /**
       ...
       * evicted anchor.
       **/
      evictedAnchorRoots: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Bytes>> & QueryableStorageEntry<ApiType>;
      version: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
    };
    fees: {
      [index: string]: QueryableStorageEntry<ApiType>;
      fees: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<Fee>> & QueryableStorageEntry<ApiType>;
      version: AugmentedQuery<ApiType, () => Observable<u64>> & QueryableStorageEntry<ApiType>;
    };
  }
